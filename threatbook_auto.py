...
class ThreatbookAuto:
    def __init__(self):
        ...
        self.x_csrf_token, self.xx_csrf = get_csrf_token(self.COOKIE)
...
#先从环境变量获取，如果没有，则从配置文件中获取
    def get_threatbook_cookie(self):
        threatbook_cookie = os.getenv('THREATBOOK_COOKIE')
        if threatbook_cookie:
            return threatbook_cookie
        return self.config.TASK.COOKIE
